...
################## Latent Traversal Methods ##################
    ...
    def plot_single_latent_traversal(self, latent_idx, ref_img=None, num_samples=10, figsize=(10, 3)):
        ...
        traversal_images = model_utils.traverse_single_latent(
            self.vae_model, latent_idx, self.max_traversal_type, self.max_traversal, num_samples, ref_img=ref_img
        )
    ...
    def plot_all_latent_traversals(self, ref_img=None, num_samples=10, figsize=(10, 3)):
        ...
        all_traversals = model_utils.traverse_all_latents(
            self.vae_model, self.max_traversal_type, self.max_traversal, num_samples, ref_img=ref_img
        )
