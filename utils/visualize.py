...
class BaseVisualizer(ABC):
    ...
    @abstractmethod
    def _generate_all_traversals(self, num_samples, max_traversal_type, max_traversal, ref_img):
        """Generate traversal images for all latent dimensions."""
        pass
...
################## Latent Traversal Methods ##################
    ...
    def plot_all_latent_traversals(self,
        ...
        if use_ref_img:
            ...
            ref_img = None # Use the prior (mean=0, std=1) for traversal
              # Generate the traversal images for all latent dimensions using the abstract method
        all_traversals = self._generate_all_traversals(
            num_samples=num_samples, 
            max_traversal_type=max_traversal_type, 
            max_traversal=max_traversal, 
            ref_img=ref_img,
...
class NVAEVisualizer(BaseVisualizer):
    ...
    def _generate_all_traversals(self, 
        ...
        """Generate traversal images for all latent dimensions using N-VAE utils."""
        return self.n_vae_utils.traverse_all_latents(
            vae_model=self.vae_model,
            num_samples=num_samples,
            max_traversal_type=max_traversal_type,
            max_traversal=max_traversal,
...
class SVAEVisualizer(BaseVisualizer):
    ...
    def _generate_all_traversals(self, 
        ...
        """Generate traversal images for all latent dimensions using S-VAE utils.
        """
        
        return self.s_vae_utils.traverse_all_toroidal_latents(
            vae_model=self.vae_model,
            num_samples=num_samples,
            max_traversal_type=max_traversal_type,
            max_traversal=max_traversal,
