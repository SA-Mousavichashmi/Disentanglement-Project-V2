...
################## Latent Traversal Methods ##################
    ...
    def plot_single_latent_traversal(self, latent_idx, ref_img=None, num_samples=10, figsize=(10, 3), max_traversal_type: str = 'probability', max_traversal: float = 0.475):
    ...
    def plot_all_latent_traversals(self, ref_img=None, num_samples=10, figsize=(10, 3), max_traversal_type: str = 'probability', max_traversal: float = 0.475):
        ...
        all_traversals = model_utils.traverse_all_latents(
            self.vae_model, max_traversal_type, max_traversal, num_samples, ref_img=ref_img
        )
