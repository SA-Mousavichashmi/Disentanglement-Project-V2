...
class Loss(baseloss.BaseLoss):
    ...
    thresh_mode : str, optional
        Mode for thresholding shared latent entries ("kl", "symmetric_kl", "dist").
        
    average_mode : str, optional
        Mode for averaging posteriors between pairs ("gvae", "mlvae").
        
    thresh_ratio : float, optional
        Threshold ratio for determining shared latents.
        
    beta : float, optional
        Weight of the KL divergence term.
        
    annealing : str, optional
        Annealing strategy ("higgins" or other).
