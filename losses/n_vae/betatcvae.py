...
class Loss(baseloss.BaseLoss):
    ...
    def __call__(self, data, reconstructions, stats_qzx, samples_qzx, is_train, **kwargs):
        ...
        log_qzx_cross = math_utils.log_density_gaussian(
        ...
        log_qzx = math_utils.log_density_gaussian(samples_qzx, *stats_qzx).view(batch_size, -1).sum(1)
        ...
        log_pz = math_utils.log_density_gaussian(samples_qzx, zeros, zeros).sum(1)
