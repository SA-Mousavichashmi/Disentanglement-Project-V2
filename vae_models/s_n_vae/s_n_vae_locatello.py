...
class Model(S_N_VAE_base):
    def __init__(self, img_size, latent_factor_topologies=['R1', 'S1', 'R1'], encoder_decay=0., decoder_decay=0., decoder_output_dist='bernoulli', **kwargs):
        """
        ...
        # Create encoder that outputs the correct number of parameters
