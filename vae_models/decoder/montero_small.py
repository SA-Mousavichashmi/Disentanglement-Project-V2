...
class Decoder(BaseDecoder):
    ...
    def __init__(self, img_size, latent_dim=10, output_dist="bernoulli", use_batchnorm=False):
        ...
        ------------
        - 5 convolutional layers with decreasing channels, (4 x 4 kernel), (stride of 2)
        ...
        self.reshape = (128, inp_width, inp_width)
        ...
        self.convT1 = nn.ConvTranspose2d(128, 64, kernel_size, **cnn_kwargs)
        self.bn1 = nn.BatchNorm2d(64) if self.use_batchnorm else nn.Identity()
        
        self.convT2 = nn.ConvTranspose2d(64, 64, kernel_size, **cnn_kwargs)
        self.bn2 = nn.BatchNorm2d(64) if self.use_batchnorm else nn.Identity()
        
        self.convT3 = nn.ConvTranspose2d(64, 32, kernel_size, **cnn_kwargs)
        self.bn3 = nn.BatchNorm2d(32) if self.use_batchnorm else nn.Identity()
        
        self.convT4 = nn.ConvTranspose2d(32, 32, kernel_size, **cnn_kwargs)
        self.bn4 = nn.BatchNorm2d(32) if self.use_batchnorm else nn.Identity()
        
        # Last layer keeps bias so pixels can shift freely; no BN here        
        self.convT5 = nn.ConvTranspose2d(32, n_chan, kernel_size, stride=2, padding=1)
